...
const Orders = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      console.log("Response from orders backend", res);
      ...
      if (res.data.success) {
        ...
        res.data.orders.map((order) => {
          ...
          console.log('all orders',allOrdersItems);
        });
        ...
        {orderData?.map((item, index) => (
          ...
          >
            ...
            <div className="md:w-1/2 flex justify-between">
              ...
              <button onClick={fetchOrders} className="border px-4 py-2 text-sm font-medium rounded-sm">
                {" "}
                Track Order
              </button>
            </div>
