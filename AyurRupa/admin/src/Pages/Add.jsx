...
setLoading(false)
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gao-3" action="">
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
          ...
          value={subCategory} className="w-full  px-3 py-2 ">
      ...
      {loading === false ? <button type="submit" className="w-28 py-3 mt-4 bg-black text-white">    ADD
        </button> :null}
